 ...
 * @package SimplePages
 */
class LUSTRE_IndexController extends Omeka_Controller_AbstractActionController
{    
    public function init()
    {
        // Set the model class so this controller can perform some functions, 
        // such as $this->findById()
        $this->_helper->db->setDefaultModelName('LUSTREPage');
    }
    ...
    { 
        $formOptions = array('type' => 'LUSTRE_page', 'hasPublicPage' => true);
        if ($page && $page->exists()) {
        ...
        $form->addElementToSaveGroup(
            ...
            array(
                'id' => 'LUSTRE-parent-id',
                'multiOptions' => LUSTRE_get_parent_options($page),
